...
[`Makerworld`](https://makerworld.com/en/models/3284600-sonoff-dual-r3-case#profileId-3726005) is a case for the Sonoff Dual R3 with cutouts for two panel-mount Schuko sockets, so the printer and the fan just plug in. No hardwiring, no open terminals. 🔌🔌
